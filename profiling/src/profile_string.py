...
def time_one_error_model_string(desc_string: str, e_mech: error_mechanism, e_type: error_type, runs: int = 10, max_workers=os.cpu_count()):  # noqa: E501, PLR2044
    """
...
def time_tab_err_string(runs: int = 100, seed: int | None = 42, write_path: str = "results/string_times.csv") -> pd.DataFrame:  # noqa: E501
    ...
    for e_type_name, e_type in e_type_dict.items():
        ...
        dataframes.append(time_one_error_model_string(desc, e_mech, e_type, runs))
